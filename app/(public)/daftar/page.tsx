...
export default function DaftarPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (
        !formData.informasiPribadi.nik.trim() ||
        !/^\d{16}$/.test(formData.informasiPribadi.nik)
      ) {
      ...
      const dataToSubmit = {
        ...
        pendidikanPekerjaan: {
          ...
          pekerjaanSaatIni:
            formData.pendidikanPekerjaan.pekerjaanSaatIni || "Tidak ada",
        },
        motivasiReferensi: {
          ...formData.motivasiReferensi,
          alasanMengikuti:
            formData.motivasiReferensi.alasanMengikuti || "Tidak diisi",
          sumberInformasi:
            formData.motivasiReferensi.sumberInformasi || "Tidak diisi",
        },
      };
                ...
                <form onSubmit={handleSubmit} className="space-y-6 mt-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="relative">
                        ...
                        <select
                          ...
                          value={
                            formData.pendidikanPekerjaan.pendidikanTerakhir
                          }
                          onChange={handleChange}
                  ...
                  <div className="bg-linear-to-r from-purple-50 to-fuchsia-50 rounded-xl p-6 border border-purple-100">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      {[
                        ...
                        {
                          value: "paket-sablon-dtf",
                          label: "PAKET SABLON DTF",
                          price: "-",
                        },
                      ].map((paket) => (
                        <label
                      ...
                      <div className="mt-4 p-4 bg-linear-to-r from-yellow-100 to-amber-100 border border-amber-300 rounded-lg">
                        <p className="text-sm font-semibold text-amber-800">
                          💡 Promo: Bayar penuh sekarang dan dapatkan diskon
                          13%!
                        </p>
                      </div>
                    </div>
                  ...
                  <div className="bg-linear-to-r from-amber-50 to-orange-50 rounded-xl p-6 border border-amber-100">
                    ...
                    <div className="space-y-6">
                      ...
                      <div>
                        <label className="block text-sm font-medium text-gray-700 mb-1">
                          Darimana Anda Mengetahui Program Ini?
                        </label>
                        <select
                  ...
                  <div className="flex justify-center py-4">
                    <Turnstile
                      ...
                      onError={() => {
                        setToken(null);
                        setError(
                          "Gagal memverifikasi keamanan. Silakan coba lagi.",
                        );
                      }}
                    />
                  </div>
